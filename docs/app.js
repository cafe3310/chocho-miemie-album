document.addEventListener("DOMContentLoaded", () => {
  ...
  function openModal(asset, type) {
    modalTitle.textContent = asset.alt || asset.title || "";
    ...
    if (type === "video") {
      modalMediaContainer.innerHTML = `<video src="${assetUrl}" autoplay loop muted playsinline controls style="max-height:70vh; width:100%; object-fit:contain;"></video>`;
    } else {
      modalMediaContainer.innerHTML = `<img src="${assetUrl}" alt="${altText}" style="max-height:70vh; width:100%; object-fit:contain;">`;
    }
